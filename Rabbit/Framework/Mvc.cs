...
namespace Rabbit
{
    ...
    // rabbit routing 
    public class MvcRouteHandler : IRouteHandler, IRequiresSessionState 
    {
    ...
    public class MvcHandler : IHttpHandler
    {
        ...
        {
            if (context.Request.AppRelativeCurrentExecutionFilePath != "~/r.ashx")
            {
                context.Server.TransferRequest("~/Rabbit.cshtml" + context.Request.RawUrl, true);
            }
        }
    }
}